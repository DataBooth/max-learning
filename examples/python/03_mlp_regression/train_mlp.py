...
def train_and_save_weights():
    ...
    print(f"   ✓ Extracted weights: W1{weights['W1'].shape}, W2{weights['W2'].shape}, W3{weights['W3'].shape}")
    ...
    for i in sample_indices:
        ...
        print(f"  True: ${true_val*100:6.1f}k  Predicted: ${pred_val*100:6.1f}k  Error: ${error*100:5.1f}k")
    print("-" * 60)

...
def main():
    ...
    print("   ✓ Weights loaded (trained to 99.10% test accuracy)\\n")
    ...
    try:
        ...
        if args.device == "gpu":
            ...
            print("   Note: Convolution ops may not be available on Apple Silicon GPU yet\\n")
            return
        else:
            raise
    ...
    accuracy = 100.0 * correct / len(images)
    print("=" * 80)
